        ...
        <a href="/" class="navbar-brand">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav  text-center">
              ...
              <?php if(isset($_SESSION['is_admin']) && !empty($_SESSION['is_admin']) && ($_SESSION['is_admin'] === 1 || $_SESSION['is_admin'] === 2)){ ?>
                <a class="nav-link <?= ($_SERVER['REQUEST_URI'] === '/admin_edit.php?id=' . isset($_GET['id']) ? $_GET['id'] : '' || $_SERVER['REQUEST_URI'] === '/admin_users_list.php') ? 'active' : NULL ?>" href="admin_users_list.php">Admin panel</a>
                <a class="nav-link <?= ($_SERVER['REQUEST_URI'] === '/admin_edit.php?id=' . isset($_GET['id']) ? $_GET['id'] : '' || $_SERVER['REQUEST_URI'] === '/admin_users_list.php') ? 'active' : NULL ?>"href="position_name.php">Edit positions</a>
              <?php }; ?>
